...
;(function ($) {
    ...
    var getScrollbarWidth = function () {
        ...
        // remove divs
        // (DISABLED AS THIS WAS SHIFTING PAGE RIGHT 5 px) outer.parentNode.removeChild(outer);

        // (DISABLED AS THIS WAS SHIFTING PAGE RIGHT 5 px) return widthNoScroll - widthWithScroll;
    };
