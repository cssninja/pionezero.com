...
"use strict";
    ...
    // BEGIN: 12 wave .. pi one zero note > wave-one is smaller bottom one that was originally #fff, changed to #ede9f0 .. wave-two blend that works > rgba(237, 233, 240, 0.8), or, the rgba version of #ede9f0
    var myWave  = function(){
        if($('#wave-one').length){
